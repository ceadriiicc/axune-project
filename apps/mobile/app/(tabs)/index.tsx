    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {running ? (
          ...
          <Pressable style={styles.workspaceAction} onPress={() => router.push('/workspace')}>
            <View>
              <Text style={styles.actionEyebrow}>Claude Code</Text>
        ...
        {claude?.installed ? (
          <Text style={styles.agentQuiet}>{AGENTS.claude.name} ready</Text>
        ) : null}
      </ScrollView>
    </SafeAreaView>
  );
