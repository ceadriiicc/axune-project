...
const makeStyles = (color: ReturnType<typeof useTheme>['palette']) =>
  StyleSheet.create({
    ...
    nowPrompt: { color: color.text, fontSize: 17, lineHeight: 23, letterSpacing: -0.25 },
    liveActivity: { flexDirection: 'row', alignItems: 'center', gap: 7 },
    ...
    primaryAction: { borderRadius: 12, paddingHorizontal: 15, paddingVertical: 11 },
